...
// --- INITIALIZATION ---
function init() {
    // Mobile browsers (specifically iOS Safari) block AudioContext until a user explicitly interacts with the screen. 
    // This invisible listener unlocks the audio context on their very first tap.
    const unlockAudio = () => {
...
function handleInput(e) {
    ...
    // Prevent default touch behavior (ghost clicks)
